import { PuzzleSize } from './gameMenu';

export default class SizeToggle {
  private readonly sizes: PuzzleSize[] = ['xs', 's', 'm', 'l', 'xl'];
  ...
  public get selectedSizeAsVector() {
    switch (this._selectedSize) {
      ...
      case 's':
        return createVector(8, 8);
      case 'm':
        return createVector(12, 12);
      case 'l':
        return createVector(20, 20);
      case 'xl':
        return createVector(30, 30);
      case 'xxl':
        return createVector(40, 40);
    }
  }
