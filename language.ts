...
const translations = {
  ...
  'Snap tolerance': {
    sv: 'Fästtolerans',
    no: 'Festtoleranse',
    da: 'Fastholdelsestolerance',
    de: 'Einrasttoleranz',
    fi: 'Kiinnittymistoleranssi',
  },
  Harder: {
    sv: 'Svårare',
    no: 'Vanskeligere',
  ...
  'Show puzzle controls': {
    sv: 'Visa pusselkontroller',
    no: 'Vis pusselkontroller',
    da: 'Vis pusselkontroller',
    de: 'Puzzle-Steuerelemente anzeigen',
    fi: 'Näytä palapelikontrollit',
  },
  'Large image preview': {
    sv: 'Stor bildförhandsvisning',
    no: 'Stor bildeforhåndsvisning',
    da: 'Stor billedforhåndsvisning',
    de: 'Große Bildvorschau',
    fi: 'Suuri kuvaesikatselu',
  },
  'Show cursors': {
    sv: 'Visa muspekare',
    no: 'Vis musepekere',
    da: 'Vis musemarkører',
    de: 'Mauszeiger anzeigen',
    fi: 'Näytä kursorit',
  },
  'Show selected pieces': {
    sv: 'Visa markerade bitar',
    no: 'Vis valgte brikker',
    da: 'Vis valgte brikker',
    de: 'Ausgewählte Teile anzeigen',
    fi: 'Näytä valitut palat',
  },
  'Show FPS counter': {
    sv: 'Visa FPS räknare',
    no: 'Vis FPS-teller',
  ...
  'Reset Database': {
    sv: 'Återställ databas',
    no: 'Tilbakestill database',
    da: 'Nulstil database',
    de: 'Datenbank zurücksetzen',
    fi: 'Nollaa tietokanta',
  },
  Resetting: {
    sv: 'Återställer',
    no: 'Tilbakestiller',
  ...
  'This will delete all saved puzzles. Are you sure?': {
    sv: 'Detta raderar alla sparade pussel. Är du säker?',
    no: 'Dette vil slette alle lagrede puslespill. Er du sikker?',
    da: 'Dette vil slette alle gemte puslespil. Er du sikker?',
    de: 'Dadurch werden alle gespeicherten Puzzles gelöscht. Sind Sie sicher?',
    fi: 'Tämä poistaa kaikki tallennetut pulmat. Oletko varma?',
  },
  'Database reset successfully! Refresh the page.': {
    sv: 'Databasen återställd! Uppdatera sidan.',
    no: 'Database tilbakestilt! Oppdater siden.',
    da: 'Database nulstillet! Opdater siden.',
    de: 'Datenbank erfolgreich zurückgesetzt! Seite aktualisieren.',
    fi: 'Tietokanta nollattu onnistuneesti! Päivitä sivu.',
  },
  'Failed to reset database': {
    sv: 'Misslyckades återställa databasen',
    no: 'Kunne ikke tilbakestille database',
    da: 'Kunne ikke nulstille database',
    de: 'Datenbank konnte nicht zurückgesetzt werden',
    fi: 'Tietokannan nollaus epäonnistui',
  },
  'Failed to load puzzle': {
    sv: 'Misslyckades ladda pussel',
    no: 'Kunne ikke laste puslespill',
    da: 'Kunne ikke indlæse puslespil',
    de: 'Puzzle konnte nicht geladen werden',
    fi: 'Pulmapelin lataus epäonnistui',
  },
  'Please try resetting the database or using a different image': {
    sv: 'Försök återställa databasen eller använda en annan bild',
    no: 'Prøv å tilbakestille databasen eller bruke et annet bilde',
    da: 'Prøv at nulstille databasen eller bruge et andet billede',
